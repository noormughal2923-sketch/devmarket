const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-REj_Qory.js","assets/index-B9uEH-Dg.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, y as Primitive, z as useDirection, A as useControllableState, R as Root2$1, C as useId, D as useComposedRefs, F as Anchor, G as composeEventHandlers, H as useLayoutEffect2, I as Portal$1, J as reactDomExports, K as createPopperScope, M as createCollection, N as useCallbackRef, Q as hideOthers, T as useFocusGuards, V as ReactRemoveScroll, W as FocusScope, X as DismissableLayer, Y as createContextScope, _ as createSlot, $ as Content, a0 as Arrow, h as cn, a1 as useSize, u as useListProducts, a2 as useAdminSetProductActive, a3 as useAdminCreateProduct, P as ProductCategory, a as Button, S as Skeleton, B as Badge, a4 as __vitePreload } from "./index-REj_Qory.js";
...
async function fileToExternalBlob(file) {
  const { ExternalBlob: EB } = await __vitePreload(async () => {
    const { ExternalBlob: EB2 } = await import("./index-REj_Qory.js").then((n) => n.an);
...
function AdminProducts() {
  ...
  const previewInputRef = reactExports.useRef(null);
  ...
  async function handleToggleActive(id, current) {
    try {
      ...
      ue.success(`Product ${!current ? "activated" : "deactivated"}.`);
    } catch (err) {
      ue.error(
        `Failed: ${err instanceof Error ? err.message : "Unknown error"}`
      );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage your digital product catalog" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": "admin.products_table", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
        ...
        "div",
        {
          ...
          children: 'No products yet. Click \\"Create Product\\" to add your first one.'
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-border bg-muted/30", children: ["ID", "Title", "Category", "Price (USD)", "Active"].map(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: (products ?? []).map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 font-medium text-foreground max-w-[240px] truncate", children: p.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: p.category }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-5 py-3 text-right font-mono text-foreground", children: [
                "$",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  checked: p.isActive,
                  onCheckedChange: () => handleToggleActive(p.id, p.isActive),
      ...
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Create New Product" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleCreate, className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin.create_product_dialog.category_select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "p-tags", children: "Tags (comma-separated)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "p-tags",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Preview Image" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      onClick: () => {
                        var _a;
                        return (_a = previewInputRef.current) == null ? void 0 : _a.click();
                      },
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: form.previewFile ? form.previewFile.name : "Click to upload preview image" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: (e) => {
                        var _a;
                        return setField("previewFile", ((_a = e.target.files) == null ? void 0 : _a[0]) ?? null);
                      }
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Product File (ZIP / Archive)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-5 h-5" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: form.productFile ? form.productFile.name : "Click to upload product file" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: (e) => {
                        var _a;
                        return setField("productFile", ((_a = e.target.files) == null ? void 0 : _a[0]) ?? null);
                      }
                    }
                  )
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2 pt-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: uploading ? "Creating…" : "Create Product"
                    }
                  )
                ] })
              ] })
